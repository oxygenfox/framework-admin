...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'andrysetyoso@gmail.com', // your gmail
            'smtp_pass' => 'OxygenFox0796', // your password gmail
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('andrysetyoso@gmail.com', 'Owl Admin'); // from('your email', 'Your Name');
